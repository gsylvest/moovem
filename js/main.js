function videoUrl(hmmmm){
    document.getElementById("videoSrc").src = hmmmm;
}

function expandNav() {
    var element = document.getElementById("navDrawer");
    element.classList.toggle("navExpand");
}

function rotateNav() {
    var element = document.getElementById("expander");
    element.classList.toggle("rot");
}

function closeNav() {
	var element = document.getElementById("navDrawer");
	element.classList.remove("navExpand");
	var element = document.getElementById("expander");
    element.classList.toggle("rot");	
}
